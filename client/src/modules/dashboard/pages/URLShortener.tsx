        ...
        {analyticsRows.length ? (
          <div className="space-y-5 max-[350px]:space-y-4">
            ...
            <div className="overflow-hidden rounded-[1.75rem] border border-[hsl(var(--border))] bg-[hsl(var(--card))]">
              <div className="hidden gap-4 border-b border-[hsl(var(--border))] px-5 py-3 md:grid md:grid-cols-[minmax(0,1.8fr)_90px_150px_100px] xl:grid-cols-[minmax(0,1.9fr)_100px_170px_120px]">
              ...
              <ToolExpandableRows
                items={analyticsRows.map((item) => ({
                  id: item.id,
                  trigger: (
                    <div className="grid gap-3 max-[350px]:gap-2 md:items-center md:grid-cols-[minmax(0,1.8fr)_90px_150px_100px] xl:grid-cols-[minmax(0,1.9fr)_100px_170px_120px]">
                      ...
                      <div className="md:text-center">
                        ...
                        <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-2.5 py-1 text-[10px] font-medium text-emerald-600 max-[350px]:px-2 max-[350px]:text-[9px] dark:bg-emerald-400/10 dark:text-emerald-300">
                ...
                chevronClassName="text-[hsl(var(--muted-foreground))]"
              />
            </div>
          </div>
        ) : (
